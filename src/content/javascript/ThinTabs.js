...
Components.utils.import("chrome://thintabs/content/javascript/sfab/StyleSheet.js");

var ThinTabs = {
	preferences : new Preferences(),
	
	styleSheet : new StyleSheet("ThinTabs"),
	...
	initPreferences : function() {
		...
		var tabmixSupport = function(name, value) {
			...
			_this.styleSheet.register("tabmixplus.support", cssTabMixSupport.toCSS());
		}
		...
		var tabsHeightFunction = function(name, value) {
			...
			_this.styleSheet.register("tabs.height", css.toCSS());
			...
			_this.styleSheet.register("tabs.height-secondary", cssSecondary.toCSS());
			...
			if (_this.preferences.getBool("tabs.force_height")) {
				...
				_this.styleSheet.register("tabs.height-force", cssForcedHeight.toCSS());
			} else {
				_this.styleSheet.unregister("tabs.height-force");
			}
		...
		var tabsWidthFunction = function(name, value) {
			if (_this.preferences.getBool("tabs.width.override")) {
				...
				_this.styleSheet.register("tabs.width", css.toCSS());
			} else {
				_this.styleSheet.unregister("tabs.width");
			}
		}
		...
		var fontFamilyFunction = function(name, value) {
			if (_this.preferences.getBool("text.font.family.override")) {
				...
				_this.styleSheet.register("text.font.family", css.toCSS());
			} else {
				_this.styleSheet.unregister("text.font.family");
			}
		};
		...
		var fontSizeFunction = function(name, value) {
			if (_this.preferences.getBool("text.font.size.override")) {
				...
				_this.styleSheet.register("text.font.size", css.toCSS());
			} else {
				_this.styleSheet.unregister("text.font.size");
			}
		};
